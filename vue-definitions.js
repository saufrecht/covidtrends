...
let app = new Vue({
  ...
  methods: {
    ...
    pullData(selectedData) {
      ...
      if (selectedData == 'Confirmed Cases') {
       Plotly.d3.csv("/covid/testdata_cases.csv", this.processData);
      } else if (selectedData == 'Reported Deaths') {
       Plotly.d3.csv("/covid/testdata_deaths.csv", this.processData);
      }
    },
  ...
  data: {
    ...
    selectedCountries: ['Napa', 'Solano', 'Sonoma', 'Marin', 'Contra Costa', 'Alameda', 'San Mateo', 'San Francisco', 'Santa Clara'],
